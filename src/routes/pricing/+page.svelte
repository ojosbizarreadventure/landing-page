...
<svelte:head>
	...
	<meta
		name="description"
		content="Explore OJO pricing plans for AI-powered CRM, Projects, HR, Payroll, and Finance management. Flexible business software pricing built for growing SMBs."
	/>
	...
	<meta
		...
		content="Compare OJO pricing plans for AI-native CRM, Projects, HR, Payroll, and Finance software built for SMBs."
	/>
...
<section class="hero" style="min-height:auto;padding-bottom:40px;text-align:center">
	<div class="container">
		...
		<p class="body-l reveal" style="max-width:520px;margin:0 auto 32px;text-align:center">AI-powered work OS for SMBs. Sales, Projects, HR, Finance — with AI built in.</p>
		...
		<div class="grid-3">
			...
			<div class="price-card">
				...
				<div class="pr-feats">
					...
					<div class="pr-feat">Full CRM, Projects, HR & Accounts</div>
...
<section class="section section-alt" style="padding-top:clamp(64px,9vw,120px)">
	<div class="container">
		...
		<div class="cmp-notes reveal">
			...
			<div class="cmp-note">All plans include <strong>every OJO module</strong> — Contacts, Leads, Projects, HR, Accounts, Vendors, Org Admin.</div>
...
<style>
	...
	.cmp-h-btn-fill:hover { background: #B91C1C; }
	.cmp-h-btn-line {
	...
	.cmp-cell.cmp-pop-col:hover { background: rgba(220, 38, 38, .1); }
	.cmp-feat-label {
