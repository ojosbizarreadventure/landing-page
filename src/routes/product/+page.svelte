	...
	const modules = [
		...
		},
		{
			...
			features: [
				...
				'Work orders through Planned, In progress, QC, Done',
				'Factory Score: on-time delivery and quality in one number'
			]
		},
		{
			tab: 'HR & People',
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="AI business operating system, SMB ERP software, manufacturing ERP, production planning software, MRP for SMBs, shop floor control, AI CRM software, project management platform, HR payroll software, finance automation platform"
	/>
...
<section class="hero" style="min-height:auto;padding-bottom:40px">
	<div class="container">
		<div class="hero-content">
			...
			<p class="body-l hero-desc reveal">From lead capture to dispatch to invoice collection, every department shares one brain, one timeline, one source of truth.</p>
...
<section class="section" style="padding-top:40px;border-top:1px solid var(--bd)">
	<div class="container">
		...
		<h2 class="d2 reveal" style="margin-bottom:12px">From first lead to <span class="accent">last shipment.</span></h2>
		<p class="body-m reveal" style="max-width:460px;margin-bottom:0">No handoff gaps. No re-entry. No context loss. Every step informs the next &mdash; and the next one already knows what happened.</p>
		<div class="flow-row reveal" style="gap:12px">
			<div class="flow-s">
				<div style="margin:0 auto 10px;width:40px;height:40px;border-radius:10px;background:var(--tq-g);border:1px solid var(--tq-bd);display:flex;align-items:center;justify-content:center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--tq)" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></div>
				<div class="flow-l">Lead Capture</div><div class="flow-d">AI scores & qualifies</div>
			</div>
			<div class="flow-s">
				<div style="margin:0 auto 10px;width:40px;height:40px;border-radius:10px;background:var(--tq-g);border:1px solid var(--tq-bd);display:flex;align-items:center;justify-content:center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--tq)" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div>
				<div class="flow-l">Quote & Order</div><div class="flow-d">Auto-generated, e-signed</div>
			</div>
			<div class="flow-s">
				<div style="margin:0 auto 10px;width:40px;height:40px;border-radius:10px;background:var(--tq-g);border:1px solid var(--tq-bd);display:flex;align-items:center;justify-content:center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--tq)" stroke-width="2"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg></div>
				<div class="flow-l">Plan & Produce</div><div class="flow-d">Material checked, WO released</div>
			</div>
			<div class="flow-s">
				<div style="margin:0 auto 10px;width:40px;height:40px;border-radius:10px;background:var(--tq-g);border:1px solid var(--tq-bd);display:flex;align-items:center;justify-content:center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--tq)" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
				<div class="flow-l">QC & Dispatch</div><div class="flow-d">Checked, packed, shipped</div>
			</div>
			<div class="flow-s">
				<div style="margin:0 auto 10px;width:40px;height:40px;border-radius:10px;background:var(--tq-g);border:1px solid var(--tq-bd);display:flex;align-items:center;justify-content:center"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--tq)" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
		...
		<div class="grid-2 reveal">
			<div class="cell">
				...
				<div style="display:flex;flex-direction:column;gap:10px">
					...
					<div class="feat-li"><div class="feat-ck">&#10003;</div>Understands role context (owner sees the P&amp;L, supervisor sees the line)</div>
				</div>
			</div>
			<div class="cell">
				...
				<div style="display:flex;flex-direction:column;gap:10px">
					...
					<div class="feat-li"><div class="feat-ck">&#10003;</div>Ranks which work order to release first, and says why</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		...
		<div class="grid-3 reveal">
			<div class="cell">
				...
				<div class="prob-d">Every action &mdash; lead created, material issued, batch QC&rsquo;d, invoice paid &mdash; is logged in one place. No more reconstructing history across five tools at audit time.</div>
			</div>
			<div class="cell">
				<div class="val-i">&#9201;</div>
			...
			<div class="cell">
				...
				<div class="prob-d">See how the order book loads the shop floor, how a shortage becomes a late delivery, and how delivery becomes cash &mdash; all from one dashboard.</div>
			</div>
		</div>
