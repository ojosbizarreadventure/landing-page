...
<section class="hero" style="min-height:auto;padding-bottom:40px">
	<div class="container">
		<div class="hero-content">
			<p class="label reveal">Company</p>
			<h1 class="d1 reveal" style="max-width:640px">Building the OS that <span class="accent">SMBs deserve.</span></h1>
			<p class="body-l hero-desc reveal">Born from watching talented teams drown in coordination instead of focusing on what they do best: building, selling, growing.</p>
		</div>
	</div>
</section>
...
<section class="section">
	<div class="container">
		...
		<div class="val-grid reveal">
			<div class="cell">
				<div class="val-i">&#9678;</div>
				<div class="val-t">AI-first, human-centered</div>
				<div class="val-d">Intelligence that augments decisions, not replaces judgment. The human always stays in the loop.</div>
			</div>
			<div class="cell">
				<div class="val-i">&#9671;</div>
				<div class="val-t">Data-driven decisions</div>
				<div class="val-d">Every recommendation, alert, and insight is grounded in your real-time business data, not assumptions or templates.</div>
			</div>
			<div class="cell">
				<div class="val-i">&#11041;</div>
				<div class="val-t">Sustainable operations</div>
				<div class="val-d">Built for digital-first businesses, replacing paper trails, manual follow-ups, and redundant processes with automated, eco-conscious workflows.</div>
			</div>
		</div>
	</div>
</section>
